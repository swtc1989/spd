#!/bin/sh
cp ~/Desktop/Resources/SPD/hostfiles/scripts_mutants_all/mutants_client_core/uploading_mutant249.sh ~/Desktop/Resources/SPD/hostfiles/uploading_mutant.sh
date > log.txt
...
sudo ./i386-s2e-softmmu/qemu-system-i386 s2e_disk.raw.s2e -s2e-config-file simple.lua -loadvm Exp2-NSPR2 -s2e-verbose 
